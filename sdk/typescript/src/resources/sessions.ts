...
class SessionLogs {
   ...
   * calls, this records what happened to the connection, which is what you want when a session
   * misbehaves. Same Laravel paginator. PAT-scoped.
   */
  async activity(sessionId: number, options: { page?: number; perPage?: number } = {}) {
    return data(
